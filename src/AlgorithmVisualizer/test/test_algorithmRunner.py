...
from AlgorithmVisualizer.algorithmInterface import Algorithm
from AlgorithmVisualizer.algorithmRunner import AlgorithmRunner
from AlgorithmVisualizer.algorithmRunner import NotAnAlgorithmException
